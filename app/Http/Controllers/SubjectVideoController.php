...
class SubjectVideoController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = SubjectVideo::with(['subject'])
                ->orderBy('id', 'desc')
                ->get();
    ...
    //             $videoPath = uploadFile($request->file('video_file'), 'subject_videos'); 
    //         }
    ...
    //             'video_url'   => $request->upload_type === 'youtube' ? $request->video_url : null,
    //             'video_file'  => $request->upload_type === 'local' ? $videoPath : null,
    //         ]);
     ...
     */
    public function update(Request $request, SubjectVideo $subjectVideo)
    {
        //
    }
     ...
     */
    public function destroy(SubjectVideo $subjectVideo)
    {
        //
    }
}
