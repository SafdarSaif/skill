                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-0">
                        <li class="dropdown-menu-header border-bottom">
                            <div class="dropdown-header d-flex align-items-center py-3">
                                ...
                                @if (isset($notifications) && $notifications->isNotEmpty())
                                    <div class="d-flex align-items-center h6 mb-0">
                                        <span class="badge bg-label-primary me-2">{{ $notifications->count() }}
                                            New</span>
                                        <a href="javascript:void(0)"
                                            class="btn btn-text-secondary rounded-pill btn-icon dropdown-notifications-all"
                                    ...
                                    @foreach ($notifications as $notification)
                                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="small mb-1">{{ $notification->Heading }}</h6>
                                                    <small
                                                        class="mb-1 d-block text-body">{{ $notification->Description }}</small>
                                                    <small
                                            ...
                                            <a href="javascript:void(0)"
                                                onclick="shownotifications({{ $notification->id }})">View</a>
                                        </li>
                                    @endforeach
                                @else
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            ...
                            {{-- <div class="d-grid px-2 pt-2 pb-1">
                                ...
                                <form method="POST" action="{{ route('logout') }}" x-data id="logout_form">
                                    @csrf
                                    <x-dropdown-link href="javascript:void(0)" onclick="$('#logout_form').submit()">
                                        {{ __('Log Out') }}
                                    </x-dropdown-link>
                                </form>
                            </div>  --}}
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            {{-- <script>
                function shownotifications(id) {
                    $.ajax({
                        url: "{{ route('notifications.viewnotification', '') }}/" + id,
                        type: 'GET',
