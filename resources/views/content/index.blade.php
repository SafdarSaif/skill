...
<!-- Mirrored from demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template/auth-login-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2024 07:18:59 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!-- Vendor -->
<link rel="stylesheet" href="/public/assets/vendor/libs/%40form-validation/form-validation.css" />
...
<svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M7.77295 16.3566L23.6563 0H32V6.88383C32 6.88383 31.8262 9.17836 30.6591 10.4057L19.7824 22H13.6938L7.77295 16.3566Z" fill="#7367F0" />
    ...
    <span class="app-brand-text demo text-heading fw-bold">Jamia Urdu Aligarh</span>
  </a> --}}
  <!-- /Logo -->
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-8 p-0">
      <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
        <img src="/public/assets/img/illustrations/auth-login-illustration-light.png" alt="auth-login-cover" class="my-5 auth-illustration" data-app-light-img="illustrations/auth-login-illustration-light.png" data-app-dark-img="illustrations/auth-login-illustration-dark.html">

        <img src="/public/assets/img/illustrations/bg-shape-image-light.png" alt="auth-login-cover" class="platform-bg" data-app-light-img="illustrations/bg-shape-image-light.png" data-app-dark-img="illustrations/bg-shape-image-dark.html">
      </div>
    </div>
    <!-- /Left Text -->
    ...
    <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
      <div class="w-px-400 mx-auto mt-12 pt-5">
        <h4 class="mb-1">Welcome to Skill App! 👋</h4>
          ...
          <div class="my-8">
            <div class="d-flex justify-content-between">
              <div class="form-check mb-0 ms-2">
                ...
                <label class="form-check-label" for="remember-me" value ="{{ __('Remember me') }}">
                  Remember Me
                </label>
              </div>
...
<!-- / Content -->
    ...
    <!-- Vendors JS -->
    <script src="/public/assets/vendor/libs/%40form-validation/popular.js"></script>
<script src="/public/assets/vendor/libs/%40form-validation/bootstrap5.js"></script>
<script src="/public/assets/vendor/libs/%40form-validation/auto-focus.js"></script>
