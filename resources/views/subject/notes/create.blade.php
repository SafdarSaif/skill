<div class="modal-body">
    <div class="text-center mb-3">
        <h3 class="mb-2 text-primary">Add Subject Notes</h3>
        <p class="text-muted">Fill in the subject notes details below</p>
    </div>

    <form id="subject-notes-form" action="{{ route('subjectnote.store') }}" method="POST" enctype="multipart/form-data"
        class="row g-3">
        @csrf
        ...
        <div class="col-md-12" id="link_field">
            ...
            <input type="url" name="note_link" id="note_link" class="form-control"
