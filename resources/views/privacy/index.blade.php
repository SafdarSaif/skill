...
@section('content')
    <script type="module">
        $(function() {
            var dataTablePrivacy = $('#privacy-table'),
                dt_privacy;

            if (dataTablePrivacy.length) {
                dt_privacy = dataTablePrivacy.DataTable({
                    ajax: "{{ route('privacy') }}",
                    columns: [
                    ...
                    buttons: [{
                        ...
                        attr: {
                            'onclick': "add('{{ route('privacy.create') }}', 'modal-lg')"
                        },
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <table id="privacy-table" class="table border-top">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Content</th>
